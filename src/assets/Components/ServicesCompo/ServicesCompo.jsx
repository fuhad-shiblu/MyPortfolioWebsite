  ...
  return (
    <>
      <section className='fuhadShiblu_serviceBanner w-full h-[250px] mt-5 flex flex-col justify-center items-center'>
        <h2 className='fuhadShiblu_Anim md:text-[100px] text-[50px] text-white uppercase font-bold'>services</h2>
      ...
      <div className="container mx-auto">
        <h3 className='fuhadShiblu_Anim md:text-[50px] text-[30px] text-center mt-10 mb-5 uppercase text-[#4c99d8] font-bold'>my services</h3>
