    ...
    <div className="w-full px-1 py-2 bg-[#4477CE] fixed bottom-0 z-10 block md:hidden">
      ...
      <div className="container m-auto">
        <div className="md:flex mt-5 md:justify-between md:items-center flex justify-between items-center">
            ...
            <Link className='fuhadShiblu_hireMe text-xl text-white uppercase px-5 py-3 font-bold rounded-3xl active:scale-[1.1] transition-all hover:opacity-[0.5] block md:hidden' to={'/contact'}>hire me</Link>
